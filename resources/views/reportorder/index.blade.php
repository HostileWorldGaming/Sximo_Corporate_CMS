...
<div class="sbox-tools" >
		@if($access['is_excel'] ==1)
			<a href="{{ URL::to('reportorder/download') }}" class="tips btn btn-sm btn-white" title="{{ Lang::get('core.btn_download') }}">
	...
	{!! $chart !!}
	 {!! Form::open(array('url'=>'reportorder/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
