...
class OrderController extends Controller {
	...
	public function getShow( Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			return Redirect::to('order')->with('messagetext','Record Not Found !')->with('msgstatus','error');					
		}
	}	
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			...
			return Redirect::to('order/update/'.$request->input('orderNumber'))->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
	...
	public function postDelete( Request $request)
	{
		...
		if(count($request->input('ids')) >=1)
		{
			...
			// redirect
			return Redirect::to('order?return='.self::returnUrl())
	...
	function postSavepublic( Request $request)
	{
		...
		if ($validator->passes()) {
			$data = $this->validatePost('orders');		
			 $this->model->insertRow($data , $request->input('orderNumber'));
